...
// =============================================================================
// Portal-Auth-Layout — rendert Mandanten-Login mit Kanzlei-Branding (Logo/Name,
// wie in der Sidebar) und Pflicht-Footer (Impressum + Datenschutz). Branding
// und Legal-Links werden public über tenantSlug='default' geladen.
// =============================================================================
...
export default async function PortalAuthLayout({ children }: { children: ReactNode }) {
