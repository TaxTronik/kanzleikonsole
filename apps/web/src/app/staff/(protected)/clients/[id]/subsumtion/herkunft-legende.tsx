...
export function HerkunftLegende() {
  return (
    <div className="card px-4 py-3 text-xs text-secondary leading-relaxed">
      ...
      (deterministisch) · <span className="badge-yellow text-[10px]">Interpretation</span> vom
      LLM/Heuristik als definitionsbedürftig erkannt (zu prüfen) ·{' '}
      <span className="badge-purple text-[10px]">Berater</span> eigene Definition.{' '}
      <span className="text-muted">
        Jede Markierung = eine durchgehende Linie (umschließende oben, verschachtelte darunter);{' '}
        <span className="not-italic">Hover</span> hebt die ganze Spanne hervor,
        <span className="not-italic"> gestrichelt = streitig</span>.
      </span>{' '}
