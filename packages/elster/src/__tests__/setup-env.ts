...
// Da der ElsterBridgeClient (über config.ts) transitiv @taxtronik/config lädt,
...
// echter .env vorhanden. ELSTER_BRIDGE_* bleiben bewusst ungesetzt
// (elsterConfig === null); die Client-Tests injizieren ihre Config direkt.
// =============================================================================
