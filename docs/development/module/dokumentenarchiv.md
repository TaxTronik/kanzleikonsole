...
| Unveränderlichkeit | Object-Lock je Stufe: GOBD→COMPLIANCE mit typabhängig 6/8/10 J. (§ 147 AO/§ 14b UStG), GWG→GOVERNANCE und fachlicher Lösch-Queue; DB-Trigger `document_version_immutable_protect` (auch Owner); Herabstufung/Fristverkürzung blockiert, Höherstufung oder Fristverlängerung re-stored in den gelockten Bucket |
