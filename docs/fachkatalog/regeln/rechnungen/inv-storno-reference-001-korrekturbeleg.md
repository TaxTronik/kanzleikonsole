...
implementation:
  status: partial
  summary: Für ausgelieferte In-App-Rechnungen erzeugt TaxTronik einen nummerierten negativen Korrekturbeleg mit TypeCode 381 und Referenz auf das Original.
sources:
  - kind: official_law
...
invertierten Positions- und Gesamtbeträgen, XRechnung-TypeCode `381` und
...
Menge und positivem Preis, Summen von -100, -19 und -119 Euro, TypeCode 381 und
...
Storno-Belege auf TypeCode 381 und die vorausgehende Rechnungsreferenz ab.
...
- Ist TypeCode 381 mit der verwendeten Vorzeichenlogik für alle vorgesehenen
  Empfängerprofile zulässig?
...
Normalisierung negativer Altpreise. XRechnungstests prüfen TypeCode 381,
Originalreferenz, positive BT-146-Preise und negative Mengen. DB-Tests der
