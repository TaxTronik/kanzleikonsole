...
| Aufbewahrung | 10 Jahre nach Mandatsende (§ 147 AO) |
...
| Drittlandsübermittlung | Keine |
| Aufbewahrung | 5 Jahre nach Ende der Geschäftsbeziehung (§ 8 Abs. 4 GwG) |
| TOM | Object-Lock COMPLIANCE, Hash-Chain, RBAC ADMIN/PARTNER für Verifikation |
...
### V6 — Vollmachten-Signatur (eIDAS AES)

| Feld | Inhalt |
|---|---|
| Zweck | Elektronische Bevollmächtigung zur Vertretung |
| Rechtsgrundlage | Art. 6 Abs. 1 lit. b + lit. c (eIDAS Art. 26) |
...
| Drittlandsübermittlung | Keine |
| Aufbewahrung | bis zum Widerruf, mindestens 10 Jahre |
| TOM | Magic-Link + 6-stelliger E-Mail-OTP, Hash-Chain-Audit, atomare State-Transition |
